...
data_dir = '/scratch/jyy1551/LAD/LogLLM/Datasets/Thunderbird'
...
if __name__ == '__main__':
    ...
    window_size = 100 # block의 크기(100개의 로그 템플릿을 한 묶음으로 만듦.)
    step_size = 100 # 100개짜리 block을 만든 뒤, 100칸을 건너뛰어 다음 블록을 만듦.
