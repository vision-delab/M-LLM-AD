...
data_path = r'/scratch/jyy1551/LAD/Datasets/{dataset_name}/train.csv'.format(dataset_name=dataset_name)

min_less_portion = 0.3

Bert_path = r"/scratch/jyy1551/LAD/Models/bert-base-uncased"
Llama_path = r"/scratch/jyy1551/LAD/Models/Meta-Llama-3-8B"
